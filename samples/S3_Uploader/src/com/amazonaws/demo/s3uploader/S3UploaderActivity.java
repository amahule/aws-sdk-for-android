        ...
        case PHOTO_SELECTED:
            if (resultCode == RESULT_OK) {  
                ...
                try {
                	...
                	PutObjectRequest por = new PutObjectRequest( Constants.getPictureBucket(), Constants.PICTURE_NAME, new java.io.File( filePath) );  // Content type is determined by file extension.
